...
export default function midSection({
  ...
  return (
    <div className="midsection-bg">
      ...
      <div className="battu second"><span className="spanu"></span></div>
      <div className="battu third"><span className="spanu"></span></div>
      ...
      {/* <div className="battu fourth"><span className="spanu"></span></div> */}
