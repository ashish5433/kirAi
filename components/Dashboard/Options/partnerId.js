...
export default function PartnerId() {
  ...
  return (
    <div>
        <div className='py-2 flex flex-col text-center items-center shadow-md rounded-lg m-1 border-2 border-gray-300'>
            <div className='w-44 py-1 bg-pink-700 text-slate-50'>
                Raunak Biswas
            </div>
            <div className='shadow-md shadow-violet-800 rounded-full'>
                <Image className='rounded-full' width={100} height={100} src={profilepic} alt="profilepic"/>
            </div>
            <div className='mt-2'>
                <h6>Level 2</h6>
                ...
                <h6>45 Reviews</h6>
                <PartnerPopup show={modalShow} onHide={() => setModalShow(false)}/>
                <div onClick={() => setModalShow(true)} className='px-2 py-1 rounded-md text-slate-50 text-sm bg-slate-700'>View Profile</div>
            </div>
        </div>
    </div>
  )
